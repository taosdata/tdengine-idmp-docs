...
- **[Creating an Analysis](./02-creating-analysis.md)** — The five-section creation form: General Information, Trigger, Event, Calculation, and Actions
...
- **[Configuring Actions](./08-actions.md)** — Referencing action templates in an analysis to run actions automatically when conditions are met

...
- Data analysts and process engineers are advised to read [Advanced Features](./06-advanced/index.md). You will need to understand element templates, event templates, how to create elements and dashboards, perform real-time analysis, and configure notification rules. Reading [Best Practices](./09-best-practices.md) is also recommended.
- Systems administrators are advised to read [Operations Guide](./08-operation/index.md) to understand how to install and deploy TDengine IDMP, manage system users and permissions, handle connections, configure the system, and perform backup and recovery.

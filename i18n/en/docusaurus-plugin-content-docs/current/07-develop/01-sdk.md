...
1. The host part of the request URL, which differs for different IDMP instances. For example: https://xxxx.idmp.tdengine.com
...
```sh
export CLOUD_HOST=https://xxxx.idmp.tdengine.com

...
Attributes support a wide range of data types. In addition to basic types (Int, Double, Varchar, etc.), they also support enumeration and object types. Object types include file, video, attribute, and element types. A file-type attribute can hold an uploaded file or a URL; video-type attributes are similar. An attribute-type attribute’s value is another attribute, and an element-type attribute’s value is another element.

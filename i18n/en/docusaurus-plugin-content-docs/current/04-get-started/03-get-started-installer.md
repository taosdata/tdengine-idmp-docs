...
1. Download the installation package from the following link:
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.10.4" platform="Linux-Generic" arch="x64" pkgType="Server" />

1. Run the following commands to install TDengine IDMP:

   ```bash
   tar -zxvf tdengine-idmp-enterprise-1.0.10.4-linux-generic.tar.gz && \
   cd tdengine-idmp-enterprise-1.0.10.4 && \
   sudo ./install.sh
   ```
...
1. Download the installation package from the following link:
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.10.4" platform="Linux-Red Hat" arch="x64" pkgType="Server" />

1. Run the following command to install TDengine IDMP:

   ```bash
   sudo rpm -ivh --nodeps tdengine-idmp-enterprise-1.0.10.4-linux-generic.rpm
   ```
...
1. Download the installation package from the following link:
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.10.4" platform="Linux-Ubuntu" arch="x64" pkgType="Server" />

1. Run the following command to install TDengine IDMP:

   ```bash
   sudo dpkg -i tdengine-idmp-enterprise-1.0.10.4-linux-generic.deb
   ```
...
1. Download the installation package from the following link:
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.10.4" platform="macOS" arch="x64" pkgType="Server" />

1. Run the following command to install TDengine IDMP:

   ```bash
   sudo installer -pkg tdengine-idmp-enterprise-1.0.10.4-macos-generic.pkg -target /
   ```
...
1. Download the installation package from the following link:
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.10.4" platform="Windows" arch="x64" pkgType="Server" />

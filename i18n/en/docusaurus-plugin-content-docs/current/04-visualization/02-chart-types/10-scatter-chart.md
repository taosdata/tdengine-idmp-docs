...
In addition to the [common view mode controls](../01-panels.md#panel-view-mode), the Scatter Chart adds:
...
In addition to the [common edit mode controls](../01-panels.md#panel-edit-mode), the Scatter Chart adds:

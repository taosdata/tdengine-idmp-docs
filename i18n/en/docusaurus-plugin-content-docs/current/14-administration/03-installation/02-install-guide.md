...
To upgrade TDengine IDMP, you stop all TDengine IDMP services and then run the installation package for the new version. It is not necessary to uninstall the old version of TDengine IDMP.

<Tabs>
<TabItem label="Linux/macOS" value="unix">

1. Before upgrading, back up the following directories.
...
3. Install the new version of TDengine IDMP by running the installation package.

TDengine IDMP is updated to the latest version, and your elements, panels, analyses, and other data are not affected.

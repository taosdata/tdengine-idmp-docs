...
IDMP can automatically generate visualization panels for an element based on its attributes, template, and collected time-series data. These panels are ready to use with no manual configuration required.

...
Each analysis corresponds to a **stream computation** (Stream) in TDengine. The stream name is visible in the RT analysis list and uniquely identifies the computation in the underlying database.
...
- **[Browsing and Managing Analyses](./01-browsing-analyses.md)** — The RT analysis list, toolbar controls, and row actions
- **[Creating an RT Analysis](./02-creating-analysis.md)** — The five-section creation form: General Information, Trigger, Event, Calculation, and Actions
...
- **[RT Analysis Templates](./07-analysis-templates.md)** — Defining reusable RT analysis rules in element templates
- **[Configuring Actions](./08-actions.md)** — Referencing action templates in an RT analysis to run actions automatically when conditions are met

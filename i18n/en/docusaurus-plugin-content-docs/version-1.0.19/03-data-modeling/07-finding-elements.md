...
## 3.7.1 Navigating the Asset Tree
...
Below the asset tree, the sidebar also contains two additional sections: **Element Groups** and **Element Filters**, described in [3.7.4](#374-element-groups) and [3.7.5](#375-element-filters) below.

## 3.7.2 Browsing an Element
...
### 3.7.3.1 Choosing what to search
...
### 3.7.3.2 Running a basic search
...
Click any result row to navigate directly to that element. To save the search for later reuse, click the **Save As** button in the Filter Results toolbar — see [3.7.5](#375-element-filters).

### 3.7.3.3 Advanced filters
...
### 3.7.5.1 Saving a search as an Element Filter

After running a search (see [3.7.3](#373-searching)), click the **Save As** button on the left side of the Filter Results toolbar. Enter a name and confirm. The filter is added to the **Element Filters** list in the sidebar and can be re-run at any time.

### 3.7.5.2 Working with filter results

...
<tbody>
<tr><td><strong>备份模式</strong></td><td>备份计划：按固定小时间隔执行，或每天在指定时间执行</td></tr>
<tr><td><strong>保留文件数量</strong></td><td>保留的备份文件数量，超出限制时旧文件将被删除。请根据可用磁盘空间设置此值。</td></tr>
<tr><td><strong>备份目录</strong></td><td>服务器上存储备份文件的目录路径</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td><strong>备份时间</strong></td><td>备份创建时间</td></tr>
<tr><td><strong>结果</strong></td><td>备份结果（成功或失败）</td></tr>
<tr><td><strong>备份文件</strong></td><td>备份压缩包的文件名</td></tr>
<tr><td><strong>备份详情</strong></td><td>其他详细信息或错误信息</td></tr>
</tbody>
</table>

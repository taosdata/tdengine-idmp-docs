...
点击加载项中的输入框，再点击 Excel 单元格，输入框中会显示该单元格的地址。加载项将使用此单元格中的内容作为查询参数。是否支持单元格范围取决于具体参数，详情请参阅各功能表格中的“操作”列。
...
|------|------|------|
| 数据项 | 元素的属性，可选择一个或多个 | 1. 在输入框输入关键词搜索，选择需要的数据项<br/>2. 点击搜索图标，弹出高级搜索条件，填写后确认<br/>3. 地址引用：先点击数据项，再选择 Excel 单元格，支持地址范围，组件回填展示单元格地址，解析单元格中的内容。有效内容是元素路径`/Utilities/California/Los Angeles County/Los Angeles/em-1`，获取元素路径下的所有属性，属性路径`/Utilities/California/Los Angeles County/Los Angeles/em-1 \| Current`，获取单独的属性 |
| 填充类型 | 查询插值，TDengine fill 子句填充类型（默认前一个非空值） | 支持以下类型（下拉框选择）：<br/>1. 前一个非空值<br/>2. 填充设置值<br/>3. 填充 null<br/>4. 线性填充<br/>5. 下一个非空值 <br/>支持单个 Cell 引用|
| 填充设置值 | 插值的具体值 | 仅当填充类型选择"填充设置值"时展示<br/>支持单个 Cell 引用 |
| 时间戳 | 查询数据的具体时间 | 时间选择框：<br/>1. 昨日零点值<br/>2. 今日零点值<br/>3. 当前时间<br/>或选择具体时间点 <br/>支持单个 Cell 引用|
| 输出单元格 | 数据输出到 Excel cell 的起始单元格 | 1. 点击 Excel 中的单元格自动绑定<br/>2. 手动输入符合 Excel cell 的位置字符，如 `Sheet1!A1` |
| 时间位置 | 输出数据时间列的配置 | 1. 不显示时间<br/>2. 时间在左侧<br/>3. 时间在顶部（点击切换） |
...
|------|------|------|
| 数据项 | 元素的属性，可选择一个或多个 | 1. 在输入框输入关键词搜索，选择需要的数据项<br/>2. 点击搜索图标，弹出高级搜索条件，填写后确认<br/>3. 地址引用：先点击数据项，再选择 Excel 单元格，支持地址范围，组件回填展示单元格地址，解析单元格中的内容。有效内容是元素路径`/Utilities/California/Los Angeles County/Los Angeles/em-1`，获取元素路径下的所有属性，属性路径`/Utilities/California/Los Angeles County/Los Angeles/em-1 \| Current`，获取单独的属性 |
| 开始时间 | 查询数据的开始具体时间 | 时间选择框：<br/>1. 昨日数据<br/>2. 今日数据<br/>3. 过去一天的数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 结束时间 | 查询数据的结束具体时间 | 时间选择框：<br/>1. 昨日数据<br/>2. 今日数据<br/>3. 过去一天的数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 输出单元格 | 数据输出到 Excel cell 的起始单元格 | 1. 点击 Excel 中的单元格自动绑定<br/>2. 手动输入符合 Excel cell 的位置字符，如 `Sheet1!A1` |
| 时间位置 | 输出数据时间列的配置 | 1. 不显示时间<br/>2. 时间在左侧<br/>3. 时间在顶部（点击切换） |
...
| 填充类型 | 查询插值，TDengine fill 子句填充类型（默认前一个非空值） | 支持以下类型（下拉框选择）：<br/>1. 前一个非空值<br/>2. 填充设置值<br/>3. 填充 null<br/>4. 线性填充<br/>5. 下一个非空值 <br/>支持单个 Cell 引用 |
| 填充设置值 | 插值的具体值 | 仅当填充类型选择"填充设置值"时展示 <br/>支持单个 Cell 引用 |
| 时间戳 | 查询数据的具体时间 | 输入框：可输入多个时间点 <br/>支持单个 Cell 引用 |
| 输出单元格 | 数据输出到 Excel cell 的起始单元格 | 1. 点击 Excel 中的单元格自动绑定<br/>2. 手动输入符合 Excel cell 的位置字符，如 `Sheet1!A1` |
| 时间位置 | 输出数据时间列的配置 | 1. 不显示时间<br/>2. 时间在左侧<br/>3. 时间在顶部（点击切换） |
...
| 开始时间 | 查询数据的开始具体时间 | 时间选择框：<br/>1. 昨日逐时数据<br/>2. 今日逐时数据<br/>3. 最近 24 小时数据<br/>4. 最近一周数据<br/>5. 本月逐时数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 结束时间 | 查询数据的结束具体时间 | 时间选择框：<br/>1. 昨日逐时数据<br/>2. 今日逐时数据<br/>3. 最近 24 小时数据<br/>4. 最近一周数据<br/>5. 本月逐时数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 聚合函数 | 数据进行聚合处理 | 下拉选择具体的 TDengine 聚合函数名称 <br/>支持单个 Cell 引用 |
| 输出单元格 | 数据输出到 Excel cell 的起始单元格 | 1. 点击 Excel 中的单元格自动绑定<br/>2. 手动输入符合 Excel cell 的位置字符，如 `Sheet1!A1` |
...
| 数据项 | 元素的属性，可选择一个或多个 | 1. 在输入框输入关键词搜索，选择需要的数据项<br/>2. 点击搜索图标，弹出高级搜索条件，填写后确认 <br/>3. 地址引用：先点击数据项，再选择 Excel 单元格，支持地址范围，组件回填展示单元格地址，解析单元格中的内容。有效内容是元素路径`/Utilities/California/Los Angeles County/Los Angeles/em-1`，获取元素路径下的所有属性，属性路径`/Utilities/California/Los Angeles County/Los Angeles/em-1 \| Current`，获取单独的属性|
| 时间间隔 | 拉取数据的时间间隔 | 默认值为小时 <br/>支持单个 Cell 引用 |
| 表达式 | 开始条件 START WITH，结束条件 END WITH | 输入框（属性名称需增加反引号，如 `` `current` > 5 ``） <br/>支持单个 Cell 引用 |
| 开始时间 | 查询数据的具体时间 | 时间选择框：<br/>1. 昨日逐时数据<br/>2. 今日逐时数据<br/>3. 最近 24 小时数据<br/>4. 最近一周数据<br/>5. 本月逐时数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 结束时间 | 查询数据的具体时间 | 时间选择框：<br/>1. 昨日逐时数据<br/>2. 今日逐时数据<br/>3. 最近 24 小时数据<br/>4. 最近一周数据<br/>5. 本月逐时数据<br/>或选择具体时间范围 <br/>支持单个 Cell 引用 |
| 时间单位 | 输出的时间单位转换 | 默认为秒，下拉框选择 <br/>支持单个 Cell 引用 |
| 输出单元格 | 数据输出到 Excel cell 的起始单元格 | 1. 点击 Excel 中的单元格自动绑定<br/>2. 手动输入符合 Excel cell 的位置字符，如 `Sheet1!A1` |
| 时间位置 | 输出数据时间列的配置 | 1. 不显示时间<br/>2. 时间在左侧<br/>3. 时间在顶部（点击切换） |

...
<tbody>
<tr><td><strong>地图文件</strong></td><td>上传或编辑定义区域边界的 GeoJSON 文件</td></tr>
<tr><td><strong>显示配置</strong></td><td>颜色刻度：<strong>最小值</strong>（低端的数值和颜色）、<strong>中间值</strong>（中点处的颜色）、<strong>最大值</strong>（高端的数值和颜色）。点击颜色色块进行更改。</td></tr>
<tr><td><strong>标签显示</strong></td><td>开关：在地图上显示区域名称标签</td></tr>
</tbody>
</table>

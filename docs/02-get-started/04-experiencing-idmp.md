...
最右侧是您的**头像**菜单。打开头像菜单后，顶部账户项会打开个人设置对话框，可在其中管理**个人信息**、**API Key** 和 **MFA** 相关项；具备权限的用户还可从同一菜单进入**管理后台**或启动引导页。关于个人设置与 API Key 的详细说明，请参见[第 14.8 节](../14-administration/08-profile-settings.md)。
...
2. 选择 **公共事业** > **北京** > **朝阳** > **三元桥街道** > **em-10**。该元素代表北京市朝阳区三元桥街道编号为 10 的电表。
...
1. 选择元素 **公共事业** > **北京** > **朝阳** > **三元桥街道** > **em-10**。
2. 在上下文标签栏中选择**实时分析**，页面将显示 3 个 AI 推荐问题。

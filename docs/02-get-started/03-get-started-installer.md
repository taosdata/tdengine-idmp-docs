...
1. 请点击以下链接获取最新版本的 `tar.gz` 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.15.1" platform="Linux-Generic" arch="x64" pkgType="Server" />

2. 执行以下命令，解压并安装：

   ```bash
   tar zxvf tdengine-idmp-enterprise-1.0.15.1-linux-generic.tar.gz
   cd tdengine-idmp-enterprise-1.0.15.1
   sudo ./install.sh
   ```
...
1. 请点击以下链接获取最新版本的 `.deb` 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.15.1" platform="Linux-Ubuntu" arch="x64" pkgType="Server" />

2. 执行以下命令，安装 deb 包：

   ```bash
   sudo dpkg -i tdengine-idmp-enterprise-1.0.15.1-linux-generic.deb
   ```
...
1. 请点击以下链接获取最新版本的 `.rpm` 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.15.1" platform="Linux-Red Hat" arch="x64" pkgType="Server" />

2. 执行以下命令，安装 rpm 包：

   ```bash
   sudo rpm -ivh --nodeps tdengine-idmp-enterprise-1.0.15.1-linux-generic.rpm
   ```
...
1. 请点击以下链接获取最新版本的 macOS 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.15.1" platform="macOS" arch="x64" pkgType="Server" />
...
1. 请点击以下链接获取最新版本的 Windows 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
   ...
   <PkgListV37 productName="TDengine IDMP-Enterprise" version="1.0.15.1" platform="Windows" arch="x64" pkgType="Server" />

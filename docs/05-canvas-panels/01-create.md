...
选择元素，然后选择仪表板，如果启用了预览，需先点击`关闭预览`，再点击`新建仪表板`，然后选择`组态`即进入组态编辑界面。

![组态创建入口](./images/canvas-entrance.png)

设计组态，分为如下步骤：

1. 设置画布的属性，包括布局、颜色、背景颜色、网格等
   ![画布属性](./images/canvas-properties.png)
2. 从图元库选择图元，拖拽到画布
3. 编辑、配置图元，包括：
   - 给图元配置文本、颜色、背景颜色等
...
![画布属性](./images/canvas-process.png)

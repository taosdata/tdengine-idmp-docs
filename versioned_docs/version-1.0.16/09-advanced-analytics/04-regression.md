...
![分析面板中的回归分析](./images/scatter-clustering-2.png)

2. 点击操作栏的**回归分析**图标，在弹出框内确定回归分析的算法配置。

![分析面板中的回归分析](./images/scatter-regression-2.png)

3. 点击确认后，系统将生成回归分析结果，并在散点图中显示。

![分析面板中的回归分析](./images/scatter-regression-3.png)

:::note
当前版本中，回归分析的使用入口为分析面板与散点图面板查看模式操作栏中的回归分析图标，未来版本将继续扩展算法类型和使用方式。

散点图面板在查看模式下的操作栏还提供**聚类分析**图标，可对散点数据执行聚类分析，识别数据的自然分组结构。关于散点图面板的完整配置说明，请参阅[散点图](../04-visualization/02-chart-types/12-scatter-chart.md)章节。
:::
